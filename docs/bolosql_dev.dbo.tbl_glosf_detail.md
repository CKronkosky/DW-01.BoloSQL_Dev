...
![system overview](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://github.com/CKronkosky/DW-01.BoloSQL_Dev/blob/master/docs/diagrams/src/bolosql_dev.dbo.tbl_glosf_detail.puml)
